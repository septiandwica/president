...
/**
 * Class theme_president_core_h5p_renderer.
 * 
 * @package   theme_president
 * @copyright 2025 Septian Dwi Cahyo(@septian.dwica) - https://tiancode.my.id
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class theme_president_core_h5p_renderer extends \core_h5p\output\renderer {
    /**
    ...
    public function h5p_alter_styles(&$styles, array $libraries, string $embedtype) {
        $theme = \theme_config::load('president');
    ...
    protected function get_style_url($content) {
        ...
        return \moodle_url::make_file_url("$CFG->wwwroot/pluginfile.php",
            "/$syscontext->id/theme_president/hvp/$itemid/themehvp.css");
    }
}
