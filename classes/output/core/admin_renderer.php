...
//        $output .= $this->services_and_support_content($showservicesandsupport);
     ...
     */
    private function tiancode_services_and_support_content(): string {
        return $this->render_from_template('theme_president/tiancode_services_and_support_content_banner', []);
    }
}
