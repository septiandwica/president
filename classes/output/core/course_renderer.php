...
namespace theme_president\output\core;

use html_writer;
use coursecat_helper;
use stdClass;
use core_course_list_element;
use theme_president\util\course;
use moodle_url;

/**
 * Renderers to align president's course elements to what is expect
 *
 * @package   theme_president
 * @copyright 2025 Septian Dwi Cahyo(@septian.dwica) - https://samastanuswantara.com
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
...
class course_renderer extends \core_course_renderer {
    ...
    protected function coursecat_coursebox_content(coursecat_helper $chelper, $course) {
        ...
        return $this->render_from_template('theme_president/president_coursecard', $data);
    }
    ...
    /**
     * Overrides core_course_renderer::frontpage_available_courses() to filter the course list
