...
use moodle_url;
use html_writer;
use theme_president\output\core_course\activity_navigation;
...
class core_renderer extends \theme_boost\output\core_renderer {
    ...
    public function body_attributes($additionalclasses = []) {
        $hasaccessibilitybar = get_user_preferences('themepresidentsettings_enableaccessibilitytoolbar', '');
        ...
        $fonttype = get_user_preferences('themepresidentsettings_fonttype', '');
        if ($fonttype) {
    ...
    public function get_navbar_callbacks_data() {
        $callbacks = get_plugins_with_function('president_additional_header', 'lib.php', true, true);
    ...
    public function get_module_footer_callbacks_data() {
        $callbacks = get_plugins_with_function('president_module_footer', 'lib.php', true, true);
    ...
    public function redirect_message($encodedurl, $message, $delay, $debugdisableredirect,
        ...
        $output .= $this->render_from_template('theme_president/loading-overlay', ['encodedurl' => $encodedurl]);
    ...
    public function navbar(): string {
        $newnav = new \theme_president\output\boostnavbar($this->page);
        return $this->render_from_template('core/navbar', $newnav);
    }

    /**
     * Whether we should display the main theme or site logo in the footer.
     *
     * @return bool
     */
