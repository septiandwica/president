...
$THEME->scss = function($theme) {
    return theme_president_get_main_scss_content($theme);
};
...
$THEME->extrascsscallback = 'theme_president_get_extra_scss';
$THEME->prescsscallback = 'theme_president_get_pre_scss';
$THEME->precompiledcsscallback = 'theme_president_get_precompiled_css';
$THEME->yuicssmodules = [];
