define("theme_president/accessibilitysettings_modal", [
    "exports", "core/ajax", "core/modal", "core/custom_interaction_events", "core/notification"
], (function (_exports, _ajax, _modal, CustomEvents, _notification) {
    ...
    CustomEvents = function (obj, nodeInterop) {
    ...
    class AccessibilityModal extends _modal.default {
        constructor(root) {
            super(root),
            _ajax
                .default
                ...
                .done((function (result) {
                    document
                        .getElementById("fonttype")
                        .value = result.fonttype,
                    result.enableaccessibilitytoolbar && (
        ...
        registerEventListeners() {
            ...
            this
                .getModal()
                .on(CustomEvents.events.activate, '[data-action="cancel"]', function () {
                    this.hide(),
                    this.destroy()
                }.bind(this))
        }
    }
    return _exports.default = AccessibilityModal,
    _defineProperty(
        AccessibilityModal,
        "TYPE",
        "theme_president/themesettings_modal"
    ),
    _defineProperty(
        AccessibilityModal,
        "TEMPLATE",
        "theme_president/accessibilitysettings_modal"
    ),
    _exports.default
}));
