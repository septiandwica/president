 ...
 */
define("theme_president/accessibilitybar", [
    "jquery", "core/ajax"
], (function (jQuery, Ajax) {
    window.jQuery = jQuery;
    var SELECTORS_FONT_SIZE = "#fontsize_dec, #fontsize_reset, #fontsize_inc",
        SELECTORS_SITE_COLOR = "#sitecolor_color1, #sitecolor_color2, #sitecolor_color3, #sitecolor_color4",
        fontsizeClass = null,
        fontsizeClassOp = null,
        fontsizeClassSize = null,
        fontsizeCurrentAction = null,
        sitecolorCurrentAction = null,
        AccessibilityBar = function () {
            var classList = jQuery("body")
                .attr("class")
                .split(/\s+/);
    ...
    return AccessibilityBar.prototype.registerEventListeners = function () {
        jQuery(SELECTORS_FONT_SIZE).click(function (element) {
            var btn = jQuery(element.currentTarget);
            fontsizeCurrentAction = btn.data("action"),
            this.fontSize()
        }.bind(this)),
        jQuery(SELECTORS_SITE_COLOR).click(function (element) {
            var btn = jQuery(element.currentTarget);
    ...
    AccessibilityBar.prototype.reloadFontsizeClass = function () {
        if ("reset" === fontsizeCurrentAction || "increase" === fontsizeCurrentAction && "fontsize-dec-1" === fontsizeClass || "decrease" === fontsizeCurrentAction && "fontsize-inc-1" === fontsizeClass) 
            return jQuery("body").removeClass(fontsizeClass),
            fontsizeClass = null,
            fontsizeClassOp = null,
            fontsizeClassSize = null,
            void this.toggleFontsizeButtons();
        
        "increase" === fontsizeCurrentAction && (
            null === fontsizeClassSize
                ...
                : "inc" === fontsizeClassOp && fontsizeClassSize < 6
                    ? (
        ...
        "decrease" === fontsizeCurrentAction && (
            null === fontsizeClassSize
                ? (
                ...
                : "dec" === fontsizeClassOp && fontsizeClassSize < 6
                    ? (
                        jQuery("body").removeClass(fontsizeClass),
                        fontsizeClassSize++,
                        fontsizeClass = "fontsize-dec-" + fontsizeClassSize
    ...
    AccessibilityBar.prototype.toggleFontsizeButtons = function () {
        ...
        null !== fontsizeClass && jQuery("#fontsize_reset").removeClass("disabled"),
        "inc" === fontsizeClassOp && (
            6 == fontsizeClassSize && jQuery("#fontsize_inc").addClass("disabled"),
            fontsizeClassSize < 6 && jQuery("#fontsize_inc").removeClass("disabled")
        ),
        "dec" === fontsizeClassOp && (
            6 == fontsizeClassSize && jQuery("#fontsize_dec").addClass("disabled"),
            fontsizeClassSize < 6 && jQuery("#fontsize_dec").removeClass("disabled")
        )
    },
    ...
    AccessibilityBar.prototype.reloadSitecolorClass = function () {
        ...
        "reset" !== sitecolorCurrentAction && jQuery("body").addClass(
