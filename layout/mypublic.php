...
if (user_can_view_profile($user, null, $context)) {
    $templatecontext['user'] = [
        ...
        'headerbuttons' => \theme_president\util\extras::get_mypublic_headerbuttons($context, $courseid, $user),
        'editprofileurl' => \theme_president\util\extras::get_mypublic_editprofile_url($user, $courseid),
